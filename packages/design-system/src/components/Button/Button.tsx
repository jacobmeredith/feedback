...
enum EnumButtonType {
  primary = 'bg-purple-700 text-white font-bold rounded',
  secondary = 'bg-gray-300 text-gray-700 rounded',
  outline = 'border-gray-500 text-gray-700 rounded',
  warning = 'bg-yellow-500 text-white rounded',
  danger = 'bg-red-500 text-white rounded',
  success = 'bg-green-500 text-white rounded'
}
